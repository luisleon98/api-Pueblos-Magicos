    ...
    public function messages(): array
{
    return [
        ...
        'data.imgPrincipal.max' => 'La imagen principal no debe exceder 1 MB',
        ...
        'data.arrayGaleria.max' => 'La galería de imágenes no debe exceder 1 MB en total',
        ...
        'data.id_estado.required' => 'El ID del estado es requerido',
        'data.id_estado.exists' => 'El estado no existe',
        'data.id_usuario.required' => 'El ID del usuario es requerido',
        'data.id_usuario.exists' => 'El usuario no existe',
        'data.id_pueblo.required' => 'El ID del pueblo mágico es requerido',
